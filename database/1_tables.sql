...
CREATE TABLE PHIEUDATCOC (
    ...
    TrangThai NVARCHAR(50), --Da thanh toan, Chua thanh toan, Duoc chap thuan
...
ADD MaPhieuYC VARCHAR(50) NULL FOREIGN KEY REFERENCES PHIEUYEUCAU(MaPhieuYC)

ALTER TABLE PHIEUDATCOC
ADD HinhThucThanhToan NVARCHAR(20) NULL -- Tiền mặt, Chuyển khoản
